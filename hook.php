...
function run() {
    ...
    $github_ips = array('192.30.252.36','207.97.227.253', '50.57.128.197', '108.171.174.178', '50.57.231.61');
    if (in_array($_SERVER['REMOTE_ADDR'], $github_ips)) {
        ...
        throw new Exception('This does not appear to be a valid request from Github.'.PHP_EOL.$_SERVER['REMOTE_ADDR'].PHP_EOL.$postBody);
    }
}
try {
